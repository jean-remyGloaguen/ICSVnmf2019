...
\newcommand{\thesisTitle}{Estimation du niveau sonore de sources d'intérêt au sein de mélanges sonores urbaines : application au trafic routier}
...
%\usepackage{natbib}
\usepackage{bibunits}	% pour liste de publications
\usepackage{bibentry}
